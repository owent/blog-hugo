...
tags: 
  ...
  - 未定义符号
  - cmake-toolset
title: 关于protobuf近期版本（v20/v3.20+）和 gRPC v1.54版本在某些ELF编译环境下的一些链接和编译问题
type: post
---
...
```bash
7>TGFBattleUtility.lib(BattleAffixAlgorithm.obj): Error LNK2001 : 无法解析的外部符号 "struct tgf::DBattleAffixDefaultTypeInternal tgf::_DBattleAffix_default_instance_" (?_DBattleAffix_default_instance_@tgf@@3UDBattleAffixDefaultTypeInternal@1@A)
```
