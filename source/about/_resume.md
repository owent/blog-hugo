...
* 2026.07-至今: \*\*\*
* 2025.09-2026.06: 游幻科技（上海）有限公司（追觅科技旗下） - 服务端技术负责人
* 2017.09-2025.08: 腾讯科技\(上海\)有限公司 - 北极光工作室后台组
...
> * [AICodeReviewer - AI自动化Code Review](http://github.com/atframework/AICodeReviewer/), 文档 <https://aicr.atframe.work/>
...
* 负责多个项目跨平台技术构建和各类研发工具研发集成
* 负责公司运维框架体系，各类IT系统管理，各类云原生环境搭建管理
>
> * 包含研发环境虚拟化方案选型搭建，k8s集群及内部各类组件的选型和搭建。以及一些在k8s基础上的云原生组件。

## 2017年09月 — 2025年08月：腾讯科技（上海）有限公司

* 灰境行者(Maple项目组) - UE - PC,搜撤 - 服务端研发,专家工程师
* Dungeonborne(TGF项目组) - UE - PC,搜撤 - 服务端主程,专家工程师
