...
| [libgo][15]       | Window/Linux/macOS等    | 部分，由内置调度层管理 | 很重，依赖boost | 一般     | 很好         | 较好，内置调度器，模拟chan | IO API Hook  | 仿goroutine            |
...
| [librf][35]       | 目前仅支持Windows+MSVC  | 部分，由内置调度层管理 | 依赖C++20       | 很好     | 极好         | 较好，内置调度器，模拟chan | ASIO         | 仿goroutine，仿promise |
