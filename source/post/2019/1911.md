...
本来呢，按我以前的理解，以为 [C++20 Coroutine][7] 是无栈式协程，那样的话就没啥好测得了。因为本身不带什么额外开销，并且开销可控。但是上次写 [《C++20 Coroutine》][5] 得时候发现它也是有栈协程，也是要切换上下文得。今天我就照着之前的方式来benchmark一波 [C++20 Coroutine][7] 吧。
